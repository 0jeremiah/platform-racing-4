...
const SELECT_TEXT_FONT = 'select_text_font'
...
const SET_TEXT_STRING = 'set_text_string'
const SET_TEXT_POSITION = 'set_text_position'
const SET_TEXT_SCALE = 'set_text_scale'
const SET_TEXT_FONT_SIZE = 'set_text_size'
const SET_TEXT_COLOR = 'set_text_color'
const SET_TEXT_ROTATION = 'set_text_rotation'
