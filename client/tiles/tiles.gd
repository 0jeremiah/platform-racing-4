...
func get_descriptions() -> Dictionary:
	...
	desc['4'] = "Bland, but at least it looks like a waffle."
	desc['5'] = "Poorly mortared blocks that will break if it is bumped from below."
	desc['6'] = "Lessens your jump if you hop off it, and pushes you down if you ride on its sides or bottom."
	desc['7'] = "Use this block to jump higher, or ride it on its sides or bottom."
	desc['8'] = "Run left really fast! (or right really slowly.) It's kind of like a conveyer belt, except cooler."
	desc['9'] = "Run right really fast! (or left really slowly.) It's kind of like a conveyer belt, except cooler."
	desc['10'] = "Explodes rather painfully if something or someone touches it."
	desc['11'] = "One item per customer."
	desc['12'] = "Marks a poNumber where players may start the race."
	desc['13'] = "It's like a trampoline that doesn't obey the laws of physics."
	desc['14'] = "Multiple personality disorder in block form."
	desc['15'] = "Stuns any players that dare touch this block."
	desc['16'] = "Sliperyyyyiiiee. Lowers one's acceleration."
	desc['17'] = "Bumping this block marks the end of the race."
	desc['18'] = "A block that shatters if it is hit too many times."
	desc['19'] = "Touch it, and poof! It's gone. No worries, though. It'll come back."
	desc['20'] = "Where is it going? The world may never know... (PCs are much more faster than in 2007, but it's still a good idea to use this block sparingly.)"
	desc['21'] = "Swim!"
	desc['22'] = "The wheels on the bus go round and round, round and round, round and round..."
	desc['23'] = "The world is still spinning, but in the opposite direction!"
	desc['24'] = "You can push this block around. Bully."
	desc['25'] = "Protects racers from high falls, restricted areas, or other kinds of danger by teleporting them to their last safe location."
	desc['26'] = "Grab as many items as you like! This item block will never run out. Items for all!"
	desc['27'] = "It's so happy! This block will share its happiness with you by boosting your stats if bumped."
	desc['28'] = "It's so sad. This block will share its sadness with you by decreasing your stats if bumped."
	desc['29'] = "Gives you +1 HP in deathmatches, and makes you temporarily invincible!"
	desc['30'] = "Need some more time? Then bump this block to get an extra 30 seconds in levels."
	desc['31'] = "This mischevious creature attacks anyone that gets in its way."
	desc['32'] = "Sets the player's stats to whatever you choose. Default settings is 50/50/50/50."
	desc['33'] = "Teleports a player to another teleport of the same color if it exists."
	desc['34'] = "This is reserved for the color-in of the Teleport Block, which can't be selected in the BlockPicker. You shouldn't be seeing this!"
	desc['35'] = "New-age industrial machine that can rotate any blocks connected to the bottom of it."
	desc['36'] = "Just walk into this block, and any gear in the level will move automatically! Wow!"
	desc['37'] = "A lightbreaker that can destroy one block or more, depending on how many times you run into it."
	desc['38'] = "A lightbreaker that lets you phase into a wall, and ends when you come out of said wall."
	desc['39'] = "A lightbreaker that grants you the power to fly like, well, a firefly. At least until you bump into something."
	desc['40'] = "Peekaboo! This block hides in plain sight, appears when it is touched, and disappears the moment you stop touching it."
	desc['41'] = "Bumping this block turns you into a towering giant! (or turns you back to normal if you were already small.)"
	desc['42'] = "Bumping this block turns you into a size of a mouse! (or turns you back to normal if you were already big.)"
	desc['43'] = "This block is covered in an unknown, slime-like substance that will slow you down. Ew... At least you can walljump off it."
	desc['44'] = "This morally questionable block shoots anything that enters its field of vision."
	desc['46'] = "This is reserved for the Portable Block, which can't be selected in the BlockPicker. You shouldn't be seeing this!"
	desc['47'] = "This is reserved for the Portable Mine, which can't be selected in the BlockPicker. You shouldn't be seeing this!"
	return desc
