...
@onready var sides_properties: Dictionary = {
	ConfigurableBlockSideSettings.APPEAR: {"label": "Appear Side Settings", "side_settings": {"fade_duration": 0.3, "fade_cooldown": 2.0}, "node": appear_side_settings},
	...
	ConfigurableBlockSideSettings.MINE: {"label": "Mine Side Settings", "side_settings": {"push_strength": 1000.0, "hitstun_duration": 2.5, "hp_sap": 20}, "node": mine_side_settings},
	ConfigurableBlockSideSettings.HEART: {"label": "Heart Side Settings", "side_settings": {"hp": 1, "exact": false, "invincibility": false}, "node": heart_side_settings},
	ConfigurableBlockSideSettings.HURT: {"label": "Hurt Side Settings", "side_settings": {"push_strength": 1000.0, "hitstun_duration": 2.5, "hp_sap": 20}, "node": hurt_side_settings},
	...
	ConfigurableBlockSideSettings.VANISH: {"label": "Vanish Side Settings", "side_settings": {"fade_duration": 0.3, "fade_cooldown": 2.0}, "node": vanish_side_settings}
}
