...
@onready var properties: Dictionary = {
	...
	"stat": {"label": "Stat Settings", "settings": {"infinite": false, "stat_supply": 1}, "node": stat_settings},
	ConfigurableBlockSideSettings.ITEM: {"label": "Item Settings", "settings": {"infinite": false, "item_supply": 1}, "node": item_settings},
	...
	ConfigurableBlockSettings.GEAR: {"label": "Gear Settings", "settings": {"gear_rotation": 90.0, "gear_tick": 4000.0, "gear_tock": 2.5}, "node": gear_settings}
}
